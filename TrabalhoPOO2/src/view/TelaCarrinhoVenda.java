 ...
 * @author augus
 */
public class TelaCarrinhoVenda extends javax.swing.JFrame {

    /**
     * Creates new form TelaCadastrarPeca
     */
    private static int id;
    public TelaCarrinhoVenda(int id) {
        this.id = id;
        initComponents();
    ...
    protected void preencheTabela(){
         ...
         listItemPedido = pedidoController.listarItemPedido(id);
         DefaultTableModel model = (DefaultTableModel) tabela.getModel();
         
         for(ItensPedidoModel itemPedido : listItemPedido){
            model.addRow(new Object[]{itemPedido.getId(), itemPedido.getIdPedido(), itemPedido.getQuant(), itemPedido.getIdPeca()});    
         }
    ...
    protected void inserirItemPedidoDb(){
        ...
        PedidoController pedidoController = new PedidoController();
        pedidoController.inserirItemPedido(id, Integer.parseInt(quant.getValue().toString()), Integer.parseInt((String) idPeca.getSelectedItem()));
...
//         ToDo precisa fazer um Get idPeças pro banco de dados
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "ID do Pedido", "quant", "ID da Peçal"
            }
        ) {
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        PedidoController Pedidocontroller = new PedidoController();
        Pedidocontroller.deletarItemPedido(idDelet);
        DefaultTableModel model = (DefaultTableModel) tabela.getModel();
        model.setRowCount(0);
        preencheTabela();  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCarrinhoVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCarrinhoVenda(id).setVisible(true);
            }
        });
    }
